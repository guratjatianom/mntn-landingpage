...
const Text: React.FC<TextProps> = ({
    ...
    const sizeClasses = {
        ...
        h2: `text-[36px] leading-[76.8px] font-bold ${playfair_display.className}`,
        h3: `text-[24px] leading-[38.4px] ${playfair_display.className}`,
        h4: `text-[24px] leading-[28.8px] ${montserrat.className}`,
        h5: `text-[18px] leading-[21.76px] ${montserrat.className}`,
        h6: `text-[18px] leading-[21.76px] ${montserrat.className}`,
    };
